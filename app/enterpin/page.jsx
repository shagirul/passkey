...
import Enterpin from "../../app/assets/enterpin.svg";
  ...
  return (
    <div className="h-screen w-screen bg-white flex justify-center items-center">
      <div className="flex flex-col justify-center items-center px-10  w-full">
        ...
        <Image
          className="aspect-square max-w-44 w-full"
          src={Enterpin}
          alt="EnterPin "
        ></Image>
        <h2 className="font-bold text-2xl text-gray-500 mb-5">
          Enter the 4 Digit-PIN{" "}
        </h2>
        <span className="max-w-56"> <OTPInput onComplete={onComplete} length={4}></OTPInput></span>
